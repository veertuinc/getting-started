...
services:
  $JENKINS_DOCKER_CONTAINER_NAME:
    ...
    environment:
      # - JENKINS_OPTS=" --httpPort=-1 --httpsPort=$JENKINS_SERVICE_PORT "
      - JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties"
BLOCK
docker-compose up -d
echo "Waiting for Jenkins to start properly..."
while [[ $(docker logs --tail 1 $JENKINS_DOCKER_CONTAINER_NAME 2>&1) != "FINE: Effective SlaveRestarter on : null" ]]; do
  sleep 10
done
