...
CLOUD_NATIVE_PACKAGE=${CLOUD_NATIVE_PACKAGE:-"AnkaControllerRegistry-1.22.0-5dc750f1.pkg"}
CLOUD_DOCKER_TAR=${CLOUD_DOCKER_TAR:-"anka-controller-registry-1.22.0-5dc750f1.tar.gz"}
ANKA_VIRTUALIZATION_PACKAGE=${ANKA_VIRTUALIZATION_PACKAGE:-"Anka-2.5.4.139.pkg"}
[[ "$(arch)" == "arm64" ]] && ANKA_VIRTUALIZATION_PACKAGE="Anka-3.0.0.135.13568747-beta4.pkg"
