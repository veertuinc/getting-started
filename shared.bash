...
GITLAB_DOCKER_TAG_VERSION=${GITLAB_DOCKER_TAG_VERSION:-"16.2.8-$GITLAB_RELEASE_TYPE.0"}
CONTROLLER_VERSION="1.38.0-3989ee24"
...
ANKA_VIRTUALIZATION_PACKAGE=${ANKA_VIRTUALIZATION_PACKAGE:-"Anka-3.3.7.173.pkg"}
...
GITLAB_RUNNER_CUSTOM_EXECUTOR_FILE_NAME="anka-cloud-gitlab-executor_.0.0.4_.3a54356_Linux_${RUNNER_ARCH}"
GITLAB_RUNNER_CUSTOM_EXECUTOR_VERSION="$(echo "${GITLAB_RUNNER_CUSTOM_EXECUTOR_FILE_NAME}" | grep -Eo '[0-9]\.[0-9]\.[0-9]')"
