...
AWS_BUILD_CLOUD_MAC_AMI_NAME="${AWS_BUILD_CLOUD_MAC_AMI_NAME:-"anka-build-2.5.6.147-macos-12.4"}"
...
if [[ "${AWS_BUILD_CLOUD_MAC_INSTANCE_TYPE}" == "mac2.metal" ]]; then
  AWS_BUILD_CLOUD_MAC_AMI_NAME="${AWS_BUILD_CLOUD_MAC_AMI_NAME:-"anka-build-3.1.1.152-macos-12.6-arm64"}"
fi
