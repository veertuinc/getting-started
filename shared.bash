...
[[ "$(arch)" == "arm64" ]] && SUDO="" || SUDO="sudo" # Can't open the anka viewer to install macos and addons as ${SUDO} anka.
...
CLOUD_NATIVE_PACKAGE=${CLOUD_NATIVE_PACKAGE:-"AnkaControllerRegistry-1.25.0-b2a027a4.pkg"}
CLOUD_DOCKER_TAR=${CLOUD_DOCKER_TAR:-"anka-controller-registry-1.25.0-b2a027a4.tar.gz"}
ANKA_VIRTUALIZATION_PACKAGE=${ANKA_VIRTUALIZATION_PACKAGE:-"Anka-2.5.6.147.pkg"}
[[ "$(arch)" == "arm64" ]] && ANKA_VIRTUALIZATION_PACKAGE="Anka-3.0.1.144.pkg"
...
ANKA_BASE_VM_TEMPLATE_UUID_INTEL="${ANKA_BASE_VM_TEMPLATE_UUID_INTEL:-"i12ccfa5-8757-411e-9505-128190e9854e"}" # Used in cloud_tests
ANKA_BASE_VM_TEMPLATE_UUID_APPLE="${ANKA_BASE_VM_TEMPLATE_UUID_APPLE:-"a12ccfa5-8757-411e-9505-128190e9854e"}" # Used in cloud_tests
