...
CLOUD_NATIVE_PACKAGE=${CLOUD_NATIVE_PACKAGE:-"AnkaControllerRegistry-1.16.0-05de337e.pkg"}
CLOUD_DOCKER_TAR=${CLOUD_DOCKER_TAR:-"anka-controller-registry-1.16.0-05de337e.tar.gz"}
ANKA_VIRTUALIZATION_PACKAGE=${ANKA_VIRTUALIZATION_PACKAGE:-"Anka-2.4.1.130.pkg"}
TEAMCITY_VERSION="2020.2.3"
PROMETHEUS_BINARY_VERSION=${PROMETHEUS_BINARY_VERSION:-"2.1.0"}

CLOUDFRONT_URL="https://d1efqjhnhbvc57.cloudfront.net/anka"
